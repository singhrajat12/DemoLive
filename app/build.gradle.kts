...
android {
    namespace = "com.example.demoliveproject"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.demoliveproject"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("com.google.code.gson:gson:2.9.0") // Gson library for JSON parsing
